  ...
  module Authorization
    ...
    def authorize_with_cancancan!
      if defined?(CanCan)
        ...
        raise "CanCanCan not available but configured as authorization method"
      end
    end
    ...
    def authorize_with_pundit!
      if defined?(Pundit)
        ...
        raise "Pundit not available but configured as authorization method"
      end
    end
    ...
    def authorize_custom_resource!(action, resource_class, resource)
      # Override this method in your application controller
      true
    end
