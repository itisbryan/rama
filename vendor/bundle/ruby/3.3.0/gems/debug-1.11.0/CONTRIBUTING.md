...
This section shows you how to create test file by test generator. For more smart information on creating tests, please take a look at [gentest options](#gentest-options). (You can also check by `$bin/gentest -h`)
